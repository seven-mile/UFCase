...
namespace winrt::UFCase::implementation
{
    struct SettingsPage : SettingsPageT<SettingsPage>
    {
        ...
        void SettingsPathBar_ItemClicked(BreadcrumbBar const& sender, BreadcrumbBarItemClickedEventArgs const& args);
        void SubPageFrame_Navigated(IInspectable const& sender, Navigation::NavigationEventArgs const& args);
