...
inline static auto Get##ITEM_NAME() -> APPCONFIG_##ITEM_TYPE { \
    return static_cast<APPCONFIG_##ITEM_TYPE>(AppConfig::Current().appConfig.GetNamed##ITEM_TYPE(L##SETTING_ID, DEFAULT_VALUE)); \
} \
inline static void Set##ITEM_NAME(APPCONFIG_PARAM_##ITEM_TYPE value) { \
    AppConfig::Current().appConfig.SetNamedValue(L##SETTING_ID, Windows::Data::Json::JsonValue::Parse(winrt::to_hstring(value))); \
}
